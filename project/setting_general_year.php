...
<body class="hold-transition sidebar-mini layout-fixed">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card card-default">
                        <div class="card-header">
                            <h3 class="card-title">เพิ่มลบแก้ไข ตัวเลือก ปีการศึกษา</h3>
                        </div>
                ...
                <form id="form-add">
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <input type="text" name="term" id="" class="form-control">
                            </div>
                            <div class="col-md-4 mt-2">
                                <p>ปีการศึกษา</p>
                            </div>
    ...
    <div class="modal fade" id="modal_detail" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">แก้ไขปีการศึกษา</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <form id="form-edit">
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <input type="text" name="year" id="term-show" class="form-control">
    ...
    <script>
        $('#form-add').submit(function(e) {
            e.preventDefault();
            $.ajax({
                url: '../backend/setting/g_year_save.php',
        ...
        function show_modal(e) {
            let id = e.dataset.id
            $.ajax({
                url: '../backend/setting/g_year_show_detail.php',
                data: {
                    id: id
                },
                type: 'POST',
        ...
        function delete_id(e) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: '../backend/setting/g_year_delete.php',
                        data: {
                            id: id
                        },
                        type: 'POST',
        ...
        $('#form-edit').submit(function(e) {
            e.preventDefault()
            $.ajax({
                url: '../backend/setting/g_year_update.php',
